...
public class MqLogTest {
    ...
    public void test() {
        ...
        String[] str = new String[]{"随便啦", "如果是点对点", "但是网上的各个文档都写了", "不可能同时只能跑一个队列吧", "g brokerURL = \"tcp://192.16",
                ...
                "个项目之间集成 \n" +
                        ...
                        "(2) 多语言 \n" +
                        "(3) 多项目", "系统前后端隔离 \n" +
                "(1) 前后端隔离，屏蔽高安全区", "系统间模块的耦合度，解耦 ", "深入浅出Redis-redis哨兵集群", "博主，可否做一个实际带java调用你这个ActiveMQ消息队列例子。谢谢……", "楼主，求你Java部分一整块Demo。邮箱：1146135461@qq.com"};
